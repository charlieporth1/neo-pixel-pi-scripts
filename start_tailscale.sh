...
ALT_HOME_ROUTE_5="192.168.88.0/24"
ALL_HOME_ROUTE="$HOME_ROUTE,$ALT_HOME_ROUTE_0,$ALT_HOME_ROUTE_1,$ALT_HOME_ROUTE_2,$ALT_HOME_ROUTE_3,$ALT_HOME_ROUTE_4,$ALT_HOME_ROUTE_5"
...
sudo systemctl is-active --quiet $fn || sudo systemctl restart $fn
